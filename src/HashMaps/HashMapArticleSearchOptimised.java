...
public class HashMapArticleSearchOptimised<Integer,Article> {
    ...
    public List<Entry<Integer, Article>> entryList() {
        List<Entry<Integer, Article>> list = new ArrayList<>();
        for (Entry<Integer, Article> e : table) {
            if (e != null && !e.isDeleted) {
                list.add(e);
            }
        }
    ...
    public List<Entry<Integer, Article>> entrySet() {
        List<Entry<Integer, Article>> list = new ArrayList<>();
        for (Entry<Integer, Article> e : table) {
            if (e != null && !e.isDeleted) {
                list.add(e);
