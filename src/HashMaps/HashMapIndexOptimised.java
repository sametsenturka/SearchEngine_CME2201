...
public class HashMapIndexOptimised<Integer,V> {
    ...
    public HashMapIndexOptimised(int initialCapacity, double loadFactor,
        ...
        this.table = (Entry<Integer,V>[]) new Entry[this.currentCapacityPrime];
        this.size = 0;
    ...
    public V put(Integer key, V value) {
        ...
        Entry<Integer,V> slot = table[index];
    ...
    private void resize(int newCapacity) {
        ...
        Entry<Integer,V>[] oldTable = table;

        table = (Entry<Integer,V>[]) new Entry[newCapPrime];
        ...
        for (Entry<Integer,V> e : oldTable) {
            if (e != null && !e.isDeleted) {
    ...
    private void rehashPut(Integer key, V value) {
    ...
    public String toString() {
        ...
        sb.append("HashMaps.HashMapCustom(size=").append(size).append(", capacity=").append(table.length)
                .append(", collisions=").append(collisionCount).append(")\n");
        for (int i = 0; i < table.length; i++) {
            Entry<Integer,V> e = table[i];
            sb.append(i).append(": ");
